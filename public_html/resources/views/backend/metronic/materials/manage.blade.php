...
@section('head_page_level_plugins')
    ...
    <style>
        #datatable_ajax > thead > tr.heading > th[data-col="sort"],
        #datatable_ajax > thead > tr.heading > th[data-col="status"],
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('material-manage') }}">{{ $module->father->title }}</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>Manage</span>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('material/create'))
                                        <a href="{{ route('material-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        ...
                                        <th data-col="material_code"> Material Code </th>
                                        <th data-col="material_title"> Material Title </th>
                                        <th data-col="type"> Type </th>
                                        <th data-col="sort"> Sort </th>
                                    ...
                                    <tr role="row" class="filter">
                                        <td> </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="sap_code">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="title">
                                        </td>
                                        <td>
                                            {{ Form::select('type', ['' => 'All', 'RM' => 'RM', 'PM' => 'PM'], null, ['class' => 'form-control form-filter input-sm']) }}
                                        </td>
                                        <td>
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/material/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('material');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('material/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/material/download') }}');
            });
