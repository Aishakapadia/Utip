                    ...
                    <div class="portlet light bordered form-fit">
                        ...
                        <div class="portlet-body form">
	                        ...
	                        @if(strtolower($pageMode) != 'edit')
	                            {!! Form::open(['route' => 'material-create', 'class' => 'form-horizontal form-bordered']) !!}
	                        @else
	                            {!! Form::model($material, ['method' => 'PUT', 'route' => ['material-update.material', $material->id], 'class' => 'form-horizontal form-bordered']) !!}
	                        @endif
	                            @include(admin_view('materials.form'))
	                        {!! Form::close() !!}
                            <!-- END FORM-->
                        </div>
...
@section('foot_resources')
	@if(env('ADMIN_CLIENT_VALIDATIONS', 1))
		...
		@if($pageMode != 'Edit')
			{!! JsValidator::formRequest('App\Http\Requests\Backend\MaterialStoreRequest') !!}
		@else
			{!! JsValidator::formRequest('App\Http\Requests\Backend\MaterialUpdateRequest') !!}
		@endif
	@endif
