                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                {!! Form::open( array('url' => admin_url('induction/reject'), 'class' => 'horizontal-form', 'pop' => 'form') ) !!}
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block">Please describe why you are rejecting this POP?</span>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
