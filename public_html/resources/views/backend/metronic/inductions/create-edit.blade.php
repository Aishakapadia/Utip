                    ...
                    <div class="portlet light bordered form-fit">
                        ...
                        <div class="portlet-body form">
	                        ...
	                        @if(strtolower($pageMode) != 'edit')
	                            {!! Form::open(['route' => 'pop-create', 'class' => 'form-horizontal form-bordered']) !!}
	                        @else
	                            {!! Form::model($pop, ['method' => 'PUT', 'route' => ['pop-update.pop', $pop->id], 'class' => 'form-horizontal form-bordered']) !!}
	                        @endif
	                            @include(admin_view('pops.form'))
	                        {!! Form::close() !!}
                            <!-- END FORM-->
                        </div>
...
@section('foot_resources')
	@if(env('ADMIN_CLIENT_VALIDATIONS', 1))
		...
		@if($pageMode != 'Edit')
			{!! JsValidator::formRequest('App\Http\Requests\Backend\PopStoreRequest') !!}
		@else
			{!! JsValidator::formRequest('App\Http\Requests\Backend\PopUpdateRequest') !!}
		@endif
	@endif
@stop
