                                        ...
                                        <div class="portlet blue-hoki box">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="{{ route('unit-edit.unit', $unit->id) }}" class="btn btn-default btn-sm">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ $unit->title }} </div>
                                                </div>
                                                {{--<div class="row static-info">--}}
                                                    {{--<div class="col-md-3 name"> Slug: </div>--}}
                                                    {{--<div class="col-md-9 value"> {{ $unit->slug }} </div>--}}
                                                {{--</div>--}}
                                                <div class="row static-info">
                                                ...
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($unit->created_at)) }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Updated At: </div>
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($unit->updated_at)) }} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="portlet blue-hoki box">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    <div class="col-md-12 value"> {!! $unit->description !!} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
