...
@section('head_page_level_plugins')
    ...
    <style>
        #datatable_ajax > thead > tr.heading > th[data-col="title"]
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('unit-manage') }}">{{ $module->father->title }}</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>Manage</span>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('unit/create'))
                                        <a href="{{ route('unit-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/unit/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('unit');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('unit/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/unit/download') }}');
            });
