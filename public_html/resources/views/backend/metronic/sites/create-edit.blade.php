                    ...
                    <div class="portlet light bordered form-fit">
                        ...
                        <div class="portlet-body form">
	                        ...
	                        @if(strtolower($pageMode) != 'edit')
	                            {!! Form::open(['route' => 'site-create', 'class' => 'form-horizontal form-bordered']) !!}
	                        @else
	                            {!! Form::model($site, ['method' => 'PUT', 'route' => ['site-update.site', $site->id], 'class' => 'form-horizontal form-bordered']) !!}
	                        @endif
	                            @include(admin_view('sites.form'))
	                        {!! Form::close() !!}
                            <!-- END FORM-->
                        </div>
...
@section('foot_resources')
	@if(env('ADMIN_CLIENT_VALIDATIONS', 1))
		...
		@if($pageMode != 'Edit')
			{!! JsValidator::formRequest('App\Http\Requests\Backend\SiteStoreRequest') !!}
		@else
			{!! JsValidator::formRequest('App\Http\Requests\Backend\SiteUpdateRequest') !!}
		@endif
	@endif
