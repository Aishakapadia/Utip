                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('transporter/create'))
                                        <a href="{{ route('transporter-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/transporter/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('transporter');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('transporter/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/transporter/download') }}');
            });
