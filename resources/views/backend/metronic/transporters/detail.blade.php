        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('transporter-manage') }}">{{ $module->father->title }}</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="{{ route('transporter-manage') }}">Manage</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>Details</span>
                                        ...
                                        <div class="portlet blue-hoki box">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="{{ route('transporter-edit.transporter', $transporter->id) }}" class="btn btn-default btn-sm">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ $transporter->sap_code }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Title: </div>
                                                    <div class="col-md-9 value"> {{ $transporter->title }} </div>
                                                </div>
                                                {{--<div class="row static-info">--}}
                                                    {{--<div class="col-md-3 name"> Slug: </div>--}}
                                                    {{--<div class="col-md-9 value"> {{ $transporter->slug }} </div>--}}
                                                {{--</div>--}}
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Status: </div>
                                                    <div class="col-md-9 value">
                                                        @if($transporter->active == '0')
                                                ...
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($transporter->created_at)) }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Updated At: </div>
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($transporter->updated_at)) }} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="portlet blue-hoki box">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    <div class="col-md-12 value"> {!! $transporter->description !!} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
