        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('site-manage') }}">{{ $module->father->title }}</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>Manage</span>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('site/create'))
                                        <a href="{{ route('site-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="15%" data-col="title"> Site Title </th>
                                        <th width="15%" data-col="site_type"> Site Type </th>
                                        <th width="15%" data-col="material_type"> Material Type </th>
                                        {{--<th width="25%" data-col="checkbox"> Description </th>--}}
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="site_type">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="material_type">
                                        </td>
                                        <td>
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/site/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('site');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('site/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/site/download') }}');
            });
