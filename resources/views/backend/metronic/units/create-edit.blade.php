                    ...
                    <div class="portlet light bordered form-fit">
                        ...
                        <div class="portlet-body form">
	                        ...
	                        @if(strtolower($pageMode) != 'edit')
	                            {!! Form::open(['route' => 'unit-create', 'class' => 'form-horizontal form-bordered']) !!}
	                        @else
	                            {!! Form::model($unit, ['method' => 'PUT', 'route' => ['unit-update.unit', $unit->id], 'class' => 'form-horizontal form-bordered']) !!}
	                        @endif
	                            @include(admin_view('units.form'))
	                        {!! Form::close() !!}
                            <!-- END FORM-->
                        </div>
...
@section('foot_resources')
	@if(env('ADMIN_CLIENT_VALIDATIONS', 1))
		...
		@if($pageMode != 'Edit')
			{!! JsValidator::formRequest('App\Http\Requests\Backend\UnitStoreRequest') !!}
		@else
			{!! JsValidator::formRequest('App\Http\Requests\Backend\UnitUpdateRequest') !!}
		@endif
	@endif
