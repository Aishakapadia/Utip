                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('page/create'))
                                        <a href="{{ route('page-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
...
@section('foot_resources')
    <script>
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/page/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('page');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('page/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            xGrid.setSortColumn(6, 'desc');
            xGrid.setOrderableColumnList([0, 3, 7], false);
            xGrid.init();
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/page/download') }}');
            });
