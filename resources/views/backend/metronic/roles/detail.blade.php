                                        ...
                                        <div class="portlet blue-hoki box">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="{{ route('role-edit.role', $role->id) }}" class="btn btn-default btn-sm">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ $role->title }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Slug: </div>
                                                    <div class="col-md-9 value"> {{ $role->slug }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Description: </div>
                                                    <div class="col-md-9 value"> {{ $role->description }} </div>
                                                </div>
                                                <div class="row static-info">
                                                ...
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($role->created_at)) }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Updated At: </div>
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($role->updated_at)) }} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
