                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('role/create'))
                                        <a href="{{ route('role-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
                                            <i class="fa fa-plus"></i> New
                                        </a>
                                    @endif
                                    @if(PermissionHelper::isAllowed('role/download'))
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="20%" data-col="description"> Description </th>
                                        <th width="5%" data-col="sort"> Sort </th>
                                        <th width="5%" data-col="status"> Status </th>
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/role/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('role');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('role/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/role/download') }}');
            });
