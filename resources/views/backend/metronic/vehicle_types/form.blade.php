...
<div class="form-body">
    ...
    <div class="form-group {{ $errors->has('volume') ? 'has-error' : '' }}">
        ...
        <div class="col-md-9">
            {{ Form::number('volume', null , ['id' => 'volume', 'class' => 'form-control', 'min' => '0']) }}
            <span class="help-block"> Please enter volume value</span>
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            {{ link_to_route('vehicle-type-manage', 'Cancel', [], ['class' => 'btn default']) }}
        </div>
    </div>
</div>
