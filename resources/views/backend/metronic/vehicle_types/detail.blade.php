        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('vehicle-type-manage') }}">Manage</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>Details</span>
                                        ...
                                        <div class="portlet blue-hoki box">
                                            <div class="portlet-title">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="{{ route('vehicle-type-edit.vehicle-type', $vehicleType->id) }}" class="btn btn-default btn-sm">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ $vehicleType->sap_code }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Title: </div>
                                                    <div class="col-md-9 value"> {{ $vehicleType->title }} </div>
                                                </div>
                                                {{--<div class="row static-info">--}}
                                                    {{--<div class="col-md-3 name"> Slug: </div>--}}
                                                    {{--<div class="col-md-9 value"> {{ $vehicleType->slug }} </div>--}}
                                                {{--</div>--}}
                                                <div class="row static-info">
                                                ...
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($vehicleType->created_at)) }} </div>
                                                </div>
                                                <div class="row static-info">
                                                    <div class="col-md-3 name"> Updated At: </div>
                                                    <div class="col-md-9 value"> {{ date('M d, Y h:i:s A', strtotime($vehicleType->updated_at)) }} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="portlet blue-hoki box">
                                            ...
                                            <div class="portlet-body">
                                                <div class="row static-info">
                                                    <div class="col-md-12 value"> {!! $vehicleType->description !!} </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
