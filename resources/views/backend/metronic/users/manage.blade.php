                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('user/create'))
                                        <a href="{{ route('user-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
                                            <i class="fa fa-plus"></i> New
                                        </a>
                                    @endif
                                    @if(PermissionHelper::isAllowed('user/download'))
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="15%" data-col="role"> Role </th>
                                        <th width="10%" data-col="agent"> Agent </th>
                                        <th width="15%" data-col="user"> User </th>
                                        <th width="10%" data-col="email"> Email </th>
                                        <th width="10%" data-col="contact"> Contact # </th>
                                        <th width="10%" data-col="status"> Status </th>
                                    ...
                                    <tr role="row" class="filter">
                                        <td> </td>
                                        <td>
                                            {{ Form::select('role_id', $roles, null, ['class' => 'form-control form-filter input-sm']) }}
                                        </td>
                                        <td>
                                            {{ Form::select('agent', ['' => 'All', 1 => 'True', 0 => 'False'], null, ['class' => 'form-control form-filter input-sm']) }}
                                        </td>
                                        <td>
                                        ...
                                        {{--<td>--}}
                                            {{--<div class="input-group date date-picker margin-bottom-5" data-date-format="dd/mm/yyyy">--}}
                                                {{--<input type="text" class="form-control form-filter input-sm" readonly name="date_of_birth_from" placeholder="From">--}}
                                            ...
                                            {{--<div class="input-group date date-picker" data-date-format="dd/mm/yyyy">--}}
                                                {{--<input type="text" class="form-control form-filter input-sm" readonly name="date_of_birth_to" placeholder="To">--}}
                                                {{--<span class="input-group-btn">--}}
                                                    {{--<button class="btn btn-sm default" type="button">--}}
                                                        {{--<i class="fa fa-calendar"></i>--}}
                                                    {{--</button>--}}
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/user/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('user');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('user/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/user/download') }}');
            });
