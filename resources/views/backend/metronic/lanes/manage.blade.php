                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                    @if(PermissionHelper::isAllowed('lane/create'))
                                        <a href="{{ route('lane-create') }}" class="btn btn-transparent green btn-outline btn-outline btn-circle btn-sm active">
                            ...
                            <div class="table-container">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        ...
                                        <th width="15%" data-col="title"> Lane Title </th>
                                        <th width="15%" data-col="site_from"> Site From </th>
                                        <th width="15%" data-col="site_to"> Site To </th>
                                        <th width="15%" data-col="transporters"> Transporters </th>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            {{ Form::select('site_id_from', $sites, null, ['class' => 'form-control form-filter input-sm']) }}
                                        </td>
                                        <td>
                                            {{ Form::select('site_id_to', $sites, null, ['class' => 'form-control form-filter input-sm']) }}
                                        </td>
                                        <td></td>
                                        <td>
...
@section('foot_resources')
    <script>
        ...
        var xGrid = new DataTableHelper( "#datatable_ajax", '{{ admin_url('/lane/search-data') }}' );
        jQuery(document).ready(function() {

            xGrid.setModuleName('lane');
            ...
            xGrid.onBeforeLoad( function() {
                ...
                $(document).on('click', '.btn_confirmation', function() {
                    ...
                    $(this).on('confirmed.bs.confirmation', function (e) { // take action if yes
                        e.preventDefault();
                        var self = $(this);
                        main.adminAjax('lane/delete', 'POST', {id: self.data('id')}, function(data) {
                            if(data.success) {
            ...
            $('.btn-export').on('click', function(e) {
                e.preventDefault();
                xGrid.download('{{ admin_url('/lane/download') }}');
            });
